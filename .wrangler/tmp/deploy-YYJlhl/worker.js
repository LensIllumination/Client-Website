...
var worker_default = {
  async fetch(request, env) {
    const corsHeaders = {
      ...
      // You can change this to your Vercel URL later
    ...
    try {
      ...
      if (!b2Response.ok) {
        ...
        const isQuotaError = b2Response.status === 403 && (errorBody.toLowerCase().includes("quota") || errorBody.toLowerCase().includes("limit") || errorBody.toLowerCase().includes("bandwidth") || errorBody.toLowerCase().includes("account_cap_exceeded") || errorBody.toLowerCase().includes("service_unavailable"));
